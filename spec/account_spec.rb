...
describe Account do
  ...
  describe '#update_balance' do
    ...
    context 'A valid transaction' do
      ...
      it('should return 1000 when a transaction of deposit 1000 is made') do
        transaction_deposit = instance_double("Transaction", :action => 'deposit', :time => '01/01/2020', :amount => 1000)
      ...
      it('should return 1000 when a deposit of 3000 is made followed by two withdrawals of 1000') do
        transaction_deposit = instance_double("Transaction", :action => 'deposit', :time => '01/01/2020', :amount => 3000)
        transaction_withdrawal = instance_double("Transaction", :action => 'withdraw', :time => '01/01/2020', :amount => 1000)
        @account.update_balance(transaction_deposit)
  ...
  describe '#display_balance' do
    ...
    it('should return 2000 when a deposit of 2000 is made') do
      account = Account.new
      transaction = instance_double("Transaction", :action => 'deposit', :time => '01/01/2020', :amount => 2000)
